...
def height_to_width(eye_height, eye_width):
...
if eye_size > 0.45 and eye_roundness(iris_width, iris_height, eye_size) >= 0.69 and \
        height_to_wifth(eye_height, eye_width) >= 0.59:
